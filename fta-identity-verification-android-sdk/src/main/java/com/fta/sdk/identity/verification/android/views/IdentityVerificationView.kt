package com.fta.sdk.identity.verification.android.views
...
import com.fta.sdk.identity.verification.android.bridge.NativeWebViewBridge
 ...
 */
class IdentityVerificationView @JvmOverloads constructor(
    context: Context,
    ...
    var brand: IdentityVerificationBrand? = null
    var flow: IdentityVerificationFlow? = null
    var theme: IdentityVerificationTheme? = null
    var localization: IdentityVerificationLocalization? = null
    var captureText: Map<String, String>? = null

    var listener: IdentityVerificationListener? = null
    ...
    private fun initWebViewConfig() {
        ...
        addJavascriptInterface(
            NativeWebViewBridge(object : IdentityVerificationListener {
                override fun onSuccess(result: IdentityVerificationResultModel?) = listener?.onSuccess(result) ?: Unit
                override fun onFail(result: IdentityVerificationResultModel?) = listener?.onFail(result) ?: Unit
                override fun onError(error: IdentityVerificationErrorModel?) = listener?.onError(error) ?: Unit
        ...
        webChromeClient = IdentityVerificationWebChromeClient()
        webViewClient = IdentityVerificationWebViewClient()
    }
    ...
    inner class IdentityVerificationWebViewClient : WebViewClient() {
    ...
    inner class IdentityVerificationWebChromeClient : WebChromeClient() {
    ...
    companion object {
        private const val TAG = "IdentityVerificationView"
    }
}
